...
-- TRANSACTIONS
-- *************************************
-- Une transaction permet de lancer des requêtes telles que des modifications et de les annuler si besoin, comme si nous pouvions faire un "CTRL+Z" dans une base de données.
...
ROLLBACK;  -- donne l'ordre à MySQL d'animer la transaction, l'employé reprenant son prénom
-- ou bien :
