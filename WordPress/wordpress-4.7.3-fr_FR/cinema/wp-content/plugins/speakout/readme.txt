...
SpeakOut! is a fork of the SpeakUp! plugin by Kreg Wallace that was quite good but needed updates and appears to have been abandoned.  Since version 1.2.0 SpeakOut! includes an importer from SpeakUp!.
...
Visit the [SpeakOut! Email Petitions website](http://speakout.123host.net.au/) to learn more.
...
4. See the FAQ on how to create a petition

If you already have the old SpeakUp! plugin installed, it is recommended you deactivate it to avoid confusion.  There is an importer included in SpeakOut!
...
`[signaturelist id="1"]`
In the signature settings tab you can choose to only show the first initial of the surname rather than full name.
...
= Can I import my existing petitions and signatures from the old speakup plugin? =
As of SpeakOut! version 1.2 there is an importer located at the bottom of the Email Petitions menu.  To avoid confusion it is recommended that you deactivate the old speakout plugin before running it as the two menus are almost identical.
...
Minor change to the menu title to make it more distinct from the original SpeakUp

= 1.2.0 =

Added an importer from the original speakup plugin - find it at the bottom of the email petitions menu in the dashboard
Various other bug fixes and improvements

= 1.1.6 =

CSS update - still tweaking for mobiles

= 1.1.5 =

CSS update to make widget responsive

= 1.1.4 =

CSS updates to make petition responsive
